...
def load_provider_route_rail() -> dict:
    ...
    fallback = {
        ...
        "providers": [
            ...
            {"id": "alibaba-token-plan", "label": "ALIBABA", "tier_label": None, "rank": 3, "state": "unknown", "headroom": None, "secondary_headroom": None, "reachable": True, "last_used_age_s": None, "stale_age_s": None},
    ...
    allowed_ids = {"openai-codex", "anthropic", "alibaba-token-plan", "opencode-go", "xai-oauth"}
